...
class MODEL(nn.Module):
    def __init__(self, num_concepts, num_problems, hidden_dim, hidden_layers,
        ...
        self.predict_Linear = nn.Linear(self.LSTM_feature_dim, self.num_concepts + 1)
    ...
    def forward(self, p_id, c_id, ast, target_c, result, c_embed, cur_result):
        ...
        # LSTM
        reformer_out = self.reformer(LSTM_input)
        ...
        prediction = self.predict_Linear(reformer_out.view(bs * seqlen, -1))  # 去掉dropout
